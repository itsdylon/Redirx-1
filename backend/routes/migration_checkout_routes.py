...
def create_migration_checkout_blueprint(service_factory=MigrationCheckoutService):
    ...
    def repository_error(exc):
        status = {'not_found': 404, 'invalid_input': 400, 'operation_conflict': 409, 'quote_expired': 409}.get(exc.code, 503)
