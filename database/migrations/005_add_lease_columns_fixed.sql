-- Migration 005: Add Lease-Based Locking (Fixed Version)
...
BEGIN
  ...
  -- Return job details
  RETURN QUERY
  SELECT v_job.id, v_job.user_id, v_job.project_name, v_job.old_urls, v_job.new_urls, COALESCE(v_job.attempt_count, 0) + 1;
END;
$$ LANGUAGE plpgsql;
