...
class MigrationSessionDB:
    ...
    def create_session(
        ...
        Args:
            ...
            requires_payment_unlock: Whether results are locked until project unlock is paid.
            status: Initial status for the session row.
...
class DeepMatchPreviewDB:
    ...
    def upsert_source_preview(
        ...
        opt_in_confirmed_at: Optional[str] = None,
        ...
        if opt_in_confirmed_at is not None:
            payload['opt_in_confirmed_at'] = opt_in_confirmed_at
        if completed:
